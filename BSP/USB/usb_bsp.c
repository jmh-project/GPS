...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11 | GPIO_Pin_12; //GPIO_Pin_8 (SOF) 
...
void USB_OTG_BSP_DriveVBUS(USB_OTG_CORE_HANDLE *pdev, uint8_t state)
{
  ...
  */
	...
	{ 
        ...
        //Dprintf("USB_OTG_BSP_DriveVBUS:: Power OFF\n");
	}
	else
	{
        ...
        //Dprintf("USB_OTG_BSP_DriveVBUS:: Power ON\n");
	}
