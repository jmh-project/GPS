...
#ifndef OBJECT_WINDOWS_HEADER
    #define OBJECT_WINDOWS_HEADER
...
typedef struct __Graphics
{
	...
	int	    (*TextOutAliasing)(int sx, int sy, char *str, unsigned short color, unsigned short back_color, char *font);
...
extern volatile unsigned char gROP2;
#endif
