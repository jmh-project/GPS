...
*/
#ifndef   VRAM_ADDR
  #define VRAM_ADDR 	0x68000000 // TBD by customer: This has to be the frame buffer start address
#endif
#ifndef   XSIZE_PHYS
...
int LCD_X_DisplayDriver(unsigned LayerIndex, unsigned Cmd, void * pData) 
{
	...
	switch (Cmd) 
	{
		case LCD_X_INITCONTROLLER: 
		{
			...
			//
			// LCD CHIP의 초기화를 하는 함수를 호출한다. TEECO는 미리되있으므로 통과한다.
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_INITCONTROLLER\n");
			return 0;
		}
		case LCD_X_SETVRAMADDR: 
		{
			...
			//...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETVRAMADDR\n");
			return 0;
		}
		case LCD_X_SETORG: 
		{
			...
			//...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETORG\n");
			return 0;
		}
		case LCD_X_SHOWBUFFER: 
		{
			...
			//...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SHOWBUFFER\n");
			return 0;
		}
		case LCD_X_SETLUTENTRY: 
		{
			...
			//...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETLUTENTRY\n");
			return 0;
		}
		case LCD_X_ON: 
		{
			...
			// LCD 를 ON 하는 함수를 호출한다.
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_ON\n");
			return 0;
		}
		case LCD_X_OFF: 
		{
			...
			// Required if the display controller should support switching on and off
			//
			//  LCD 를 OFF 하는 함수를 호출한다.
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_OFF\n");
			return 0;
		}
		case LCD_X_SETVIS: 
		{
			...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETVIS\n");
			break;
		}
		case LCD_X_SETPOS: 
		{
			...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETPOS\n");
			break;
		}
		case LCD_X_SETSIZE: 
		{
			...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETSIZE\n");
			break;
		}
		case LCD_X_SETALPHA: 
		{
			...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETALPHA\n");
			break;
		}
		case LCD_X_SETCHROMAMODE: 
		{
			...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETCHROMAMODE\n");
			break;
		}
		case LCD_X_SETCHROMA: 
		{
			...
			Dprintf("LCD_X_DisplayDriver::-> LCD_X_SETCHROMA\n");
			break;
		}
