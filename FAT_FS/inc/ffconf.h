...
#define _SYNC_t          osSemaphoreId 	//!< FreeRTOS를 사용하여 동기화 시킬때 사용한다.
#else
#define _FS_REENTRANT    0  /* 0:Disable or 1:Enable */
#define	_SYNC_t			HANDLE	/* O/S dependent type of sync object. e.g. HANDLE, OS_EVENT*, ID and etc.. */
#endif
#define _FS_TIMEOUT      1000 /* Timeout period in unit of time ticks */
//!< OS 를 사용할때는 _FS_REENTRANT=1 로 해야한다.
//!< uC-OS를 사용할시에는 syncobj.c를 사용하고
//!< FreeRTOS 를 사용할시에는 syscall.c 를 사용한다.
...
/* 1 이상으로 파일 잠금 제어 기능, 설정 _FS_LOCK을 가능하게합니다.
    값은 동시에 열 수있는 파일 수를 정의합니다. */
#endif /* _FFCONFIG */
#ifdef __cplusplus
}
#endif
