...
{
//Dprintf("USBH_Init::Entry..........\n");
	/* Hardware Init */
	USB_OTG_BSP_Init(pdev);  
	/* configure GPIO pin used for switching VBUS power */
//Dprintf("USBH_Init::Entry..........1\n");
	USB_OTG_BSP_ConfigVBUS(0);  

//Dprintf("USBH_Init::Entry..........2\n");
	/* Host de-initializations */
	USBH_DeInit(pdev, phost);
  
	/*Register class and user callbacks */
//Dprintf("USBH_Init::Entry..........3\n");
	phost->class_cb = class_cb;
	phost->usr_cb = usr_cb;  
    
	/* Start the USB OTG core */     
//Dprintf("USBH_Init::Entry..........4\n");
	HCD_Init(pdev , coreID);
   
	/* Upon Init call usr call back */
//Dprintf("USBH_Init::Entry..........5\n");
	phost->usr_cb->Init();

	/* Enable Interrupts */
//Dprintf("USBH_Init::Entry..........6\n");
	USB_OTG_BSP_EnableInterrupt(pdev);
//Dprintf("USBH_Init::Entry..........7\n");    
}
...
void USBH_Process(USB_OTG_CORE_HANDLE *pdev , USBH_HOST *phost)
{
    ...
    //호스트 프로세스에서 처음검지는 스틱이 빠져있는가를 검사한다.
    ...
    {  
		case HOST_IDLE :
            gUSB_MSC_Status = 0;
			//Dprintf("USBH_Process::	HOST_IDLE\n");			
		...
		case HOST_DEV_ATTACHED :
            gUSB_MSC_Status = 0;
//Dprintf("USBH_Process::	HOST_DEV_ATTACHED-------1\n");	    
			phost->usr_cb->DeviceAttached();
//Dprintf("USBH_Process::	HOST_DEV_ATTACHED-------2\n");	    
			phost->Control.hc_num_out = USBH_Alloc_Channel(pdev, 0x00);
			phost->Control.hc_num_in = USBH_Alloc_Channel(pdev, 0x80);  
//Dprintf("USBH_Process::phost->Control.hc_num_out=%d\n", phost->Control.hc_num_out);	    
//Dprintf("USBH_Process::phost->Control.hc_num_in=%d\n", phost->Control.hc_num_in);	    
		...
		case HOST_ENUMERATION:    
            gUSB_MSC_Status = 0;
//Dprintf("USBH_Process::	HOST_ENUMERATION\n");	
...
//Dprintf("USBH_Process::	HOST_USR_INPUT\n");
            //The function should return user response true to move to class state 
            if ( phost->usr_cb->UserInput() == USBH_USR_RESP_OK)
            {
                //Dprintf("USBH_Process::	HOST_USR_INPUT OK\n");
                if((phost->class_cb->Init(pdev, phost))== USBH_OK)
                {
                    //Dprintf("USBH_Process::	HOST_USR_INPUT Init\n");
                    phost->gState  = HOST_CLASS_REQUEST;     
                }
                else                
                {
                    //Dprintf("USBH_Process::	HOST_USR_INPUT Init Error\n");
                }
            }   
        ...
        case HOST_CLASS_REQUEST:  
            gUSB_MSC_Status = 0;
            //Dprintf("USBH_Process::	HOST_CLASS_REQUEST\n");	
        ...
        case HOST_CLASS:   
            //Dprintf("USBH_Process::	HOST_CLASS\n");	
        ...
        case HOST_CTRL_XFER:
            //Dprintf("USBH_Process::	HOST_CTRL_XFER\n");			
            /* process control transfer state machine */
            USBH_HandleControl(pdev, phost);    
        break;
        
        case HOST_SUSPENDED:
            //Dprintf("USBH_Process::	HOST_SUSPENDED\n");	
        break;
        ...
        case HOST_DEV_DISCONNECTED :
            //Dprintf("USBH_Process::	HOST_DEV_DISCONNECTED\n");	
            gUSB_MSC_Status = 0;
